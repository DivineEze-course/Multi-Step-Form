...
<div className="flex flex-col gap-1">
        ...
        <input className ="border-gray-500 border p-2 rounded-sm" type="text" placeholder="e.g Stephen King" value={name} onChange={(e) => setName(e.target.value)}/>
</div>
<div className="flex flex-col gap-1">
        <label className="text-sm text-blue-900">Email Address</label>
        <input className ="border-gray-500 border p-2 rounded-sm" type="text" placeholder="e.g stephenking@lorem.com" value={email} onChange={(e) => setEmail(e.target.value)}/>
</div>
<div className="flex flex-col gap-1">
        <label className="text-sm text-blue-900">Phone Number</label>
        <input className ="border-gray-500 border p-2 rounded-sm" type="text" placeholder="e.g. +1 234 567 890" value={phone} onChange={(e) => setPhone(e.target.value)}   />
 </div>
        </div>
        </div>
